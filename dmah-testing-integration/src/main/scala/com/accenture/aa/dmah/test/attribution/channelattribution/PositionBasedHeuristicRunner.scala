...
class PositionBasedHeuristicRunner extends FlatSpec with MockitoSugar with Matchers {
  
  /*val channelAttribution = Mockito.mock(classOf[HeuristicChannelAttributionPositionBased])
       ...
       /* "TestCase" should "pass as the method return a List obj" in {
         ...
         userJourneyObj2.userId = "123"
           ...
           heuristicObj.whichMethod = 1
            ...
            var listObj = (heuristicObj.callPositionBased("123", store, salesObj,weightAssignmentObj ))
